...
required <- c(
  ...
  "verifier_p_raw", "verifier_p_used", "cache_hit", "cache_hit_x",
  "cache_hit_y", "cache_hit_any", "cache_hit_all", "cache_partial_hit",
  "cache_service_mode", "residualization_compute_ms", "cache_lookup_ms",
  "cuda_single_target_calls", "cuda_solve_calls", "fallback_triggered",
