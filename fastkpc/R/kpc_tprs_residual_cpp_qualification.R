...
fastkpc_kpc_tprs_magic_optimizer_diagnostic_rows <- function(
  ...
  empty <- data.frame(
    ...
    local_pre_boundary_lambda = numeric(),
    local_magic_boundary_probe = logical(),
    local_magic_boundary_steps = integer(),
    local_magic_boundary_direction = integer(),
      ...
      diag <- tryCatch(
        ...
        error = function(e) {
          data.frame(
            ...
            local_pre_boundary_lambda = NA_real_,
            local_magic_boundary_probe = NA,
            local_magic_boundary_steps = NA_integer_,
            local_magic_boundary_direction = NA_integer_,
