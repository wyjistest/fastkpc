...
fastkpc_precision_trace_row <- function(
  ...
  cache_service_mode = NA_character_,
  cold_start = FALSE,
  residualization_compute_ms = NA_real_,
  cache_lookup_ms = NA_real_,
  cuda_single_target_calls = NA_integer_,
  cuda_solve_calls = NA_integer_,
  ...
  data.frame(
    ...
    cache_hit_x = as.logical(cache_hit_x),
    cache_hit_y = as.logical(cache_hit_y),
    cache_hit_any = as.logical(cache_hit_any),
    cache_hit_all = as.logical(cache_hit_all),
    cache_partial_hit = as.logical(cache_partial_hit),
    cache_service_mode = as.character(cache_service_mode),
    cold_start = as.logical(cold_start),
    residualization_compute_ms = as.numeric(residualization_compute_ms),
    cache_lookup_ms = as.numeric(cache_lookup_ms),
