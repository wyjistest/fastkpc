...
struct SchedulerDiagnostics {
  ...
  double residual_design_build_one_dimensional_basis_sec;
  double residual_design_build_one_dimensional_alloc_sec;
  double residual_design_build_one_dimensional_x_pack_sec;
  double residual_design_build_one_dimensional_p_build_sec;
  double residual_design_build_one_dimensional_p_pack_sec;
  int residual_design_build_one_dimensional_cols;
  int residual_design_build_one_dimensional_values;
  double residual_design_build_additive_basis_sec;
  double residual_design_build_additive_alloc_sec;
  double residual_design_build_additive_x_pack_sec;
  double residual_design_build_additive_p_build_sec;
  double residual_design_build_additive_p_pack_sec;
  int residual_design_build_additive_component_count;
  int residual_design_build_additive_basis_cols;
  int residual_design_build_additive_values;
  ...
  double residual_edf_trace_shadow_sec;
  int residual_edf_trace_shadow_count;
  int residual_edf_trace_mode_full_inverse_count;
  int residual_edf_trace_mode_shadow_count;
