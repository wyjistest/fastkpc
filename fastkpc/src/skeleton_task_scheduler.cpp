...
SchedulerDiagnostics make_scheduler_diagnostics(const std::string& scheduler,
  ...
  out.residual_design_build_intercept_count = 0;
  out.residual_design_build_one_dimensional_count = 0;
  out.residual_design_build_additive_count = 0;
  out.residual_design_build_tensor_count = 0;
  out.residual_design_build_one_dimensional_basis_sec = 0.0;
  out.residual_design_build_one_dimensional_alloc_sec = 0.0;
  out.residual_design_build_one_dimensional_x_pack_sec = 0.0;
  out.residual_design_build_one_dimensional_p_build_sec = 0.0;
  out.residual_design_build_one_dimensional_p_pack_sec = 0.0;
  out.residual_design_build_one_dimensional_cols = 0;
  out.residual_design_build_one_dimensional_values = 0;
  out.residual_design_build_additive_basis_sec = 0.0;
  out.residual_design_build_additive_alloc_sec = 0.0;
  out.residual_design_build_additive_x_pack_sec = 0.0;
  out.residual_design_build_additive_p_build_sec = 0.0;
  out.residual_design_build_additive_p_pack_sec = 0.0;
  out.residual_design_build_additive_component_count = 0;
  out.residual_design_build_additive_basis_cols = 0;
  out.residual_design_build_additive_values = 0;
  out.residual_design_build_tensor_basis_sec = 0.0;
  out.residual_design_build_tensor_alloc_sec = 0.0;
  out.residual_design_build_tensor_x_pack_sec = 0.0;
  out.residual_design_build_tensor_product_sec = 0.0;
  out.residual_design_build_tensor_p_build_sec = 0.0;
  out.residual_design_build_tensor_p_pack_sec = 0.0;
  out.residual_design_build_tensor_cols = 0;
  out.residual_design_build_tensor_values = 0;
  ...
  out.residual_edf_trace_cuda_sec = 0.0;
  out.residual_edf_trace_cuda_count = 0;
  out.residual_edf_trace_cuda_candidate_count = 0;
  ...
  out.dcov_rowsum_kernel_launch_count = 0;
  ...
  out.dcov_rowsum_max_chunk_batch = 0;
  out.dcov_rowsum_max_chunk_sec = 0.0;
  out.dcov_rowsum_max_chunk_n = 0;
