...
struct FastSplineDesignBuildDiagnostics {
  ...
  int additive_count;
  int tensor_count;
  double one_dimensional_basis_sec;
  double one_dimensional_alloc_sec;
  double one_dimensional_x_pack_sec;
  double one_dimensional_p_build_sec;
  double one_dimensional_p_pack_sec;
  int one_dimensional_cols;
  int one_dimensional_values;
  double additive_basis_sec;
  double additive_alloc_sec;
  double additive_x_pack_sec;
  double additive_p_build_sec;
  double additive_p_pack_sec;
  int additive_component_count;
  int additive_basis_cols;
  int additive_values;
