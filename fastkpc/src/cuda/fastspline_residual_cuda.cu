...
FastSplineCudaBatchResult fit_fastspline_residuals_cuda_batch_result(
  ...
  try {
    ...
    result.diagnostics.grouping_design_cache_lookup_sec = 0.0;
    result.diagnostics.grouping_design_cache_insert_sec = 0.0;
    result.diagnostics.grouping_group_lookup_sec = 0.0;
    result.diagnostics.grouping_group_insert_sec = 0.0;
    result.diagnostics.grouping_group_design_lookup_sec = 0.0;
    result.diagnostics.grouping_group_design_copy_sec = 0.0;
    result.diagnostics.grouping_group_design_index_insert_sec = 0.0;
    result.diagnostics.grouping_request_insert_sec = 0.0;
    ...
    result.diagnostics.grouping_group_design_copy_count = 0;
    result.diagnostics.grouping_group_design_x_values = 0;
    result.diagnostics.grouping_group_design_p_values = 0;
    result.diagnostics.grouping_request_insert_count = 0;
    ...
    result.diagnostics.design_cache_entries = 0;
    result.diagnostics.design_build_total_sec = 0.0;
    result.diagnostics.design_build_basis_sec = 0.0;
    result.diagnostics.design_build_penalty_sec = 0.0;
    result.diagnostics.design_build_x_pack_sec = 0.0;
    result.diagnostics.design_build_p_pack_sec = 0.0;
    result.diagnostics.design_build_alloc_sec = 0.0;
    result.diagnostics.design_build_column_extract_sec = 0.0;
    result.diagnostics.design_build_finite_check_sec = 0.0;
    result.diagnostics.design_build_unaccounted_sec = 0.0;
    result.diagnostics.design_build_count = 0;
    result.diagnostics.design_build_x_values = 0;
    result.diagnostics.design_build_p_values = 0;
    ...
    result.diagnostics.design_build_finite_check_values = 0;
    result.diagnostics.design_build_intercept_count = 0;
    result.diagnostics.design_build_one_dimensional_count = 0;
    result.diagnostics.design_build_additive_count = 0;
    result.diagnostics.design_build_tensor_count = 0;
    result.diagnostics.design_build_one_dimensional_basis_sec = 0.0;
    result.diagnostics.design_build_one_dimensional_alloc_sec = 0.0;
    result.diagnostics.design_build_one_dimensional_x_pack_sec = 0.0;
    result.diagnostics.design_build_one_dimensional_p_build_sec = 0.0;
    result.diagnostics.design_build_one_dimensional_p_pack_sec = 0.0;
    result.diagnostics.design_build_one_dimensional_cols = 0;
    result.diagnostics.design_build_one_dimensional_values = 0;
    result.diagnostics.design_build_additive_basis_sec = 0.0;
    result.diagnostics.design_build_additive_alloc_sec = 0.0;
    result.diagnostics.design_build_additive_x_pack_sec = 0.0;
    result.diagnostics.design_build_additive_p_build_sec = 0.0;
    result.diagnostics.design_build_additive_p_pack_sec = 0.0;
    result.diagnostics.design_build_additive_component_count = 0;
    result.diagnostics.design_build_additive_basis_cols = 0;
    result.diagnostics.design_build_additive_values = 0;
    result.diagnostics.design_build_tensor_basis_sec = 0.0;
    result.diagnostics.design_build_tensor_alloc_sec = 0.0;
    result.diagnostics.design_build_tensor_x_pack_sec = 0.0;
    result.diagnostics.design_build_tensor_product_sec = 0.0;
    result.diagnostics.design_build_tensor_p_build_sec = 0.0;
    result.diagnostics.design_build_tensor_p_pack_sec = 0.0;
    result.diagnostics.design_build_tensor_cols = 0;
    result.diagnostics.design_build_tensor_values = 0;
    ...
    result.diagnostics.basis_build_total_sec = 0.0;
    result.diagnostics.basis_build_alloc_sec = 0.0;
    result.diagnostics.basis_build_near_constant_sec = 0.0;
    result.diagnostics.basis_build_knots_sec = 0.0;
    result.diagnostics.basis_build_knots_copy_sec = 0.0;
    result.diagnostics.basis_build_knots_sort_sec = 0.0;
    result.diagnostics.basis_build_knots_center_sec = 0.0;
    result.diagnostics.basis_build_min_gap_sec = 0.0;
    result.diagnostics.basis_build_width_sec = 0.0;
    result.diagnostics.basis_build_eval_sec = 0.0;
    result.diagnostics.basis_build_eval_fill_sec = 0.0;
    result.diagnostics.basis_build_normalize_sec = 0.0;
    result.diagnostics.basis_build_normalize_scale_sec = 0.0;
    result.diagnostics.basis_build_fallback_sec = 0.0;
    result.diagnostics.basis_build_return_sec = 0.0;
    result.diagnostics.basis_build_unaccounted_sec = 0.0;
    result.diagnostics.basis_build_count = 0;
    result.diagnostics.basis_build_rows = 0;
    result.diagnostics.basis_build_cols = 0;
    result.diagnostics.basis_build_values = 0;
    result.diagnostics.basis_build_near_constant_count = 0;
    result.diagnostics.basis_build_fallback_row_count = 0;
    result.diagnostics.host_pack_sec = 0.0;
    result.diagnostics.alloc_sec = 0.0;
    result.diagnostics.h2d_sec = 0.0;
    result.diagnostics.h2d_design_sec = 0.0;
    result.diagnostics.h2d_penalty_sec = 0.0;
    result.diagnostics.h2d_y_sec = 0.0;
    result.diagnostics.h2d_index_sec = 0.0;
    result.diagnostics.h2d_lambda_sec = 0.0;
    result.diagnostics.h2d_active_sec = 0.0;
    result.diagnostics.h2d_copy_count = 0;
    result.diagnostics.h2d_bytes = 0.0;
    ...
    result.diagnostics.edf_trace_shadow_sec = 0.0;
    result.diagnostics.edf_trace_shadow_count = 0;
    result.diagnostics.edf_trace_mode_full_inverse_count = 0;
    result.diagnostics.edf_trace_mode_shadow_count = 0;
    ...
    result.diagnostics.edf_trace_cuda_kernel_launch_count = 0;
    result.diagnostics.edf_trace_cuda_system_count = 0;
    result.diagnostics.edf_trace_cuda_trace_terms = 0.0;
    result.diagnostics.edf_trace_cuda_p_max = 0;
    result.diagnostics.edf_trace_cuda_p_weighted_sum = 0.0;
