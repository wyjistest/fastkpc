...
struct FastSplineCudaBatchDiagnostics {
  ...
  int structural_group_key_count;
  ...
  double design_build_one_dimensional_basis_sec;
  double design_build_one_dimensional_alloc_sec;
  double design_build_one_dimensional_x_pack_sec;
  double design_build_one_dimensional_p_build_sec;
  double design_build_one_dimensional_p_pack_sec;
  int design_build_one_dimensional_cols;
  int design_build_one_dimensional_values;
  double design_build_additive_basis_sec;
  double design_build_additive_alloc_sec;
  double design_build_additive_x_pack_sec;
  double design_build_additive_p_build_sec;
  double design_build_additive_p_pack_sec;
  int design_build_additive_component_count;
  int design_build_additive_basis_cols;
  int design_build_additive_values;
  ...
  int edf_trace_cuda_kernel_launch_count;
  int edf_trace_cuda_system_count;
  double edf_trace_cuda_trace_terms;
  int edf_trace_cuda_p_max;
  double edf_trace_cuda_p_weighted_sum;
