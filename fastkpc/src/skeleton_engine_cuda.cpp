    ...
    for (int start = 0; start < static_cast<int>(requests.size());
      ...
      if (backend_.kind == ResidualBackendKind::FastSpline &&
        ...
        diagnostics->residual_design_cache_miss_count +=
          batch_result.diagnostics.design_cache_miss_count;
        diagnostics->residual_design_cache_insert_count +=
          batch_result.diagnostics.design_cache_insert_count;
        ...
        diagnostics->residual_d2h_residuals_sec +=
          batch_result.diagnostics.d2h_residuals_sec;
        diagnostics->residual_d2h_metadata_sec +=
          batch_result.diagnostics.d2h_metadata_sec;
        diagnostics->residual_d2h_info_sec +=
          batch_result.diagnostics.d2h_info_sec;
        diagnostics->residual_d2h_copy_count +=
          batch_result.diagnostics.d2h_copy_count;
        diagnostics->residual_d2h_bytes +=
          batch_result.diagnostics.d2h_bytes;
        ...
        diagnostics->residual_rhs_custom_solve_count +=
          batch_result.diagnostics.rhs_custom_solve_count;
        diagnostics->residual_rhs_cublas_solve_count +=
          batch_result.diagnostics.rhs_cublas_solve_count;
        diagnostics->residual_rhs_solve_fallback_count +=
          batch_result.diagnostics.rhs_solve_fallback_count;
        ...
        diagnostics->residual_summary_candidate_launch_count +=
          batch_result.diagnostics.summary_candidate_launch_count;
        ...
        diagnostics->residual_edf_trace_cuda_sec +=
          batch_result.diagnostics.edf_trace_cuda_sec;
        diagnostics->residual_edf_trace_cuda_count +=
          batch_result.diagnostics.edf_trace_cuda_count;
        diagnostics->residual_edf_trace_cuda_candidate_count +=
          batch_result.diagnostics.edf_trace_cuda_candidate_count;
        diagnostics->residual_edf_trace_full_inverse_skipped_count +=
          batch_result.diagnostics.edf_trace_full_inverse_skipped_count;
        diagnostics->residual_edf_trace_cuda_fallback_count +=
          batch_result.diagnostics.edf_trace_cuda_fallback_count;
        diagnostics->residual_edf_trace_cuda_values +=
          batch_result.diagnostics.edf_trace_cuda_values;
        diagnostics->residual_edf_trace_cuda_kernel_launch_count +=
          batch_result.diagnostics.edf_trace_cuda_kernel_launch_count;
        diagnostics->residual_edf_trace_cuda_system_count +=
          batch_result.diagnostics.edf_trace_cuda_system_count;
        diagnostics->residual_edf_trace_cuda_trace_terms +=
          batch_result.diagnostics.edf_trace_cuda_trace_terms;
        diagnostics->residual_edf_trace_cuda_p_max =
          std::max(diagnostics->residual_edf_trace_cuda_p_max,
                   batch_result.diagnostics.edf_trace_cuda_p_max);
        diagnostics->residual_edf_trace_cuda_p_weighted_sum +=
          batch_result.diagnostics.edf_trace_cuda_p_weighted_sum;
        diagnostics->residual_candidate_inverse_values_avoided +=
          batch_result.diagnostics.candidate_inverse_values_avoided;
